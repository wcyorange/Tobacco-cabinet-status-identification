            ...
            <form class="layui-form" action="" lay-filter="component-form-group">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="eqId" lay-verify="required" autocomplete="off" placeholder="请输入设备ID" value="${equipmentVideo.eqId}"
                               class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="videoUrl" lay-verify="required" autocomplete="off" placeholder="请输入视频保存地址" value="${equipmentVideo.videoUrl}"
                               class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="unionId" lay-verify="required" autocomplete="off" placeholder="请输入事故存储批次 时间戳" value="${equipmentVideo.unionId}"
                               class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="beginTime" lay-verify="required" autocomplete="off" placeholder="请输入视频录制开始时间" value="${equipmentVideo.beginTime}"
                               class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="endTime" lay-verify="required" autocomplete="off" placeholder="请输入视频录制结束时间" value="${equipmentVideo.endTime}"
                               class="layui-input">
                    </div>
                </div>
...
<script>
    layui.use('form', function(){
        ...
        $("#status").val("${equipmentVideo.status}");
        $("#deleteStatus").val("${equipmentVideo.deleteStatus}");
...
<script>
    layui.config({
        ...
        form.on('submit(component-form-demo)', function (data) {
            $.post("<%=request.getContextPath()%>/equipmentVideo/edit", data.field, function (data) {
                // 获取 session
