        ...
        <div class="layui-card">
            <div class="layui-card-body">
                ...
                <script type="text/html" id="test-table-toolbar-barDemo">
                    <a class="layui-btn layui-btn-xs" lay-event="edit">编辑资源信息</a>
                </script>
...
<script>
    layui.config({
        ...
        table.render({
            ...
            , title: '菜单数据表'
            , cols: [[
                {field:'sId', title: '序号', align: 'center', fixed: 'left'}
                , {field: 'sName', title: '资源名称', align: 'center', fixed: 'left'}
                , {field: 'sDesc', title: '资源描述', align: 'center', fixed: 'left'}
                , {field: 'sMobile', title: '联系电话', align: 'center', fixed: 'left', width: 120}
                , {field: 'sAddress', title: '资源地址', align: 'center', templet: '#sexTpl'}
                , {field: 'sStar', title: '星级', align: 'center'}
                , {field: 'sMoney', title: '金额', align: 'center'}
