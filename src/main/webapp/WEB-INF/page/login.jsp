...
<head>
    ...
    <title>登录 - 大学生实践教学平台管理后台</title>
    <!-- 网页 -->
    <link rel="shortcut icon" href="layuiadmin/img/xiaoweiyun.png">
...
<div id="large-header" class="large-header" style="height: 760px;">
    <div class="logo" >
<%--        <img src="<%=request.getContextPath()%>/layuiadmin/img/logo.png"  width="200px" height="70px"></div>--%>
    <canvas id="demo-canvas" width="1536" height="760"></canvas>
    <div class="logo_box">
        <h3 class="align-center">青岛卷烟厂视频监控系统</h3>
        <form action="pay/login" method="post" id="loginform">
            ...
            <div class="input_outer" style="width: 200px;">
                <div>
                <span class="us_check"></span>
                <input type="text"  name="kaptcha" class="text1"
                       style="color: #FFFFFF !important; position:absolute; z-index:100;" placeholder="请输入验证码">
                </div>
                <div class="check_num">
                    <img src="getKaptchaImage" class="layadmin-user-login-codeimg" style="height: 46px;width:100px;" id="LAY-user-get-vercode">
                </div>
            </div>
        ...
        <a href="#" class="color-white">立即注册</a>
        <a href="" class="color-white" style="float: right">忘记密码?</a>
