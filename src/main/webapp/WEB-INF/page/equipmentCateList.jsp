...
<script>
    layui.config({
        ...
        table.render({
            ...
            ,url: 'equipmentCate/listjson' //修改这个地址，列表查询路径，数据类型见json/table/demo.js
            ,toolbar: '#test-table-toolbar-toolbarDemo'
            ,title: '数据表'
            ,cols: [[
                 {field:'id', title:'id', align:'center',sort:true,fixed: 'left',width: 120}
                ...
                ,{field:'creatTime', title:'创建时间', align:'center',width: 300}
                ,{field:'updateTime', title:'更新时间', align:'center',width: 300}
                ...
                ,{field:'deleteTime', title:'删除时间', align:'center',width: 200}
        ...
        table.on('toolbar(test-table-toolbar)', function(obj){
            if(obj.event=="add"){
                parent.layui.index.openTabsPage("equipmentCate/add", "添加参数");
            }
        });
        ...
        table.on('tool(test-table-toolbar)', function(obj){
            ...
            if(obj.event === 'del'){
                ...
                layer.confirm('真的删除行么', function(index){
                    admin.req({
                        type: "POST"
                        ,url: 'equipmentCate/delete' //实际使用请改成服务端真实接口
                        ,data: data
                        ,done: function(res){
                            if(res){
                                obj.del();
                ...
                parent.layui.index.openTabsPage("equipmentCate/editForm?id="+obj.data.id, "修改参数");
            }
