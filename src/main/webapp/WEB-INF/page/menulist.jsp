            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    <div class="layui-input-inline">
                        <input type="text" name="auTitle" id="auTitle" placeholder="请输入菜单名" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-inline">
...
<script>
    layui.config({
        ...
        table.render({
            ...
            ,title: '菜单数据表'
            ,cols: [[
                {filed:'auId',title:'序列', type:'numbers', width:80, fixed: 'left' }
                ,{field:'auUrl', title:'URL', fixed: 'left', width:100}
                ,{field:'auInfo', title:'URL信息', fixed: 'left', width:150}
                ,{field:'auTitle', title:'URL标题', fixed: 'left', width:150}
                ,{field:'auClickable', title:'是否可点击', width:150,templet:function (data) {
                        if(data.auClickable == 1)
                            return "是";
                        else
                            return "否"
                    }}
                ,{field:'auPId', title:'上级菜单', width:150,templet:function (data) {
                            var msg = "";
                            var ret = {};
                            ret['auPId'] = data.auPId;
                            if(data.auPId == 0)
                                return "无上级菜单"
                            else{
                                $.ajax({
                                    ...
                                    success: function(data) {
                                        ...
                                        if (data.status == "succ") {
                                            msg = data.flatformAdminMenu.auTitle;
                                        }
                                    },
                                    error: function() {
                                    }
                ...
                ,{field:'auSort', title:'排序', width:120}
                ,{field:'auType', title:'类型'}
        ...
        table.on('tool(test-table-toolbar)', function(obj){
            ...
            if(obj.event === 'del'){
                ...
                parent.layui.index.openTabsPage("menu/echodata?id="+obj.data.auId, "修改菜单");
            }
        });
    });
</script>
