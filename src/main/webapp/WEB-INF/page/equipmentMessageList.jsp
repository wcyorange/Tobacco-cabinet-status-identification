...
<script>
    layui.config({
        ...
        table.render({
            ...
            ,url: 'equipmentMessage/listjson' //修改这个地址，列表查询路径，数据类型见json/table/demo.js
            ...
            ,cols: [[
                ...
                ,{field:'msg', title:'消息详情', align:'center',width: 120}
                ,{field:'imgUrl', title:'事故图片', align:'center',width: 120}
                ,{field:'isGood', title:'是否正常', align:'center',width: 120,templet:function(d){
                        if(d.isGood ==0)
                            return '<span style="color: #00801e">0-正常</span>';
                        else
                            return '<span style="color: red">1-异常</span>';
                    }}
        ...
        table.on('toolbar(test-table-toolbar)', function(obj){
            if(obj.event=="add"){
                parent.layui.index.openTabsPage("equipmentMessage/add", "添加参数");
            }
        });
        ...
        table.on('tool(test-table-toolbar)', function(obj){
            ...
            if(obj.event === 'del'){
                ...
                layer.confirm('真的删除行么', function(index){
                    admin.req({
                        type: "POST"
                        ,url: 'equipmentMessage/delete' //实际使用请改成服务端真实接口
                        ,data: data
                        ,done: function(res){
                            if(res){
                                obj.del();
                ...
                parent.layui.index.openTabsPage("equipmentMessage/editForm?id="+obj.data.id, "修改参数");
            }
