            ...
            <form class="layui-form" action="" lay-filter="component-form-group">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="eqId" lay-verify="required" autocomplete="off" placeholder="请输入设备ID" value="${equipmentMessage.eqId}"
                               class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="title" lay-verify="required" autocomplete="off" placeholder="请输入消息标题" value="${equipmentMessage.title}"
                               class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="msg" lay-verify="required" autocomplete="off" placeholder="请输入消息详情" value="${equipmentMessage.msg}"
                               class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="imgUrl" lay-verify="required" autocomplete="off" placeholder="请输入事故图片" value="${equipmentMessage.imgUrl}"
                               class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <select name="isGood" lay-verify="required" lay-search="" id="isGood">
                            <option value="">直接选择状态</option>
                            <option value="0">0-正常</option>
                            <option value="1">1-异常</option>
                        </select>
                    </div>
                </div>
...
<script>
    layui.use('form', function(){
        ...
        $("#isGood").val("${equipmentMessage.isGood}");
        $("#status").val("${equipmentMessage.status}");
        $("#deleteStatus").val("${equipmentMessage.deleteStatus}");
...
<script>
    layui.config({
        ...
        form.on('submit(component-form-demo)', function (data) {
            $.post("<%=request.getContextPath()%>/equipmentMessage/edit", data.field, function (data) {
                // 获取 session
        ...
        form.on('select(test)', function(data){
            if (data.value>1){
                ...
                var url = "equipmentMessage/listjson";//get
                $.ajax({
                    type:"post",
                    url: url,
                    async: false,
