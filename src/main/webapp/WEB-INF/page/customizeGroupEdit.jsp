            ...
            <form class="layui-form" action="" lay-filter="component-form-group">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="groupName" lay-verify="required" autocomplete="off" placeholder="请输入组名" value="${CustomizeGroup.groupName}"
                               class="layui-input">
                    </div>
                </div>

                <div class="layui-form-item">
                    <label class="layui-form-label">当前设备编号</label>
                    <div class="layui-input-block">
                        <input type="text"  lay-verify="required" autocomplete="off" placeholder="请输入设备编号" value="${CustomizeGroup.eqId}"
                               class="layui-input" disabled>
                    </div>
                </div>

                <div class="layui-form-item">
                    <label class="layui-form-label">需要修改的设备编号</label>
                    <div class="layui-input-block">
                        <c:forEach items="${thinkEquipments}" var="t">
                            <input type="checkbox"  name="eqId" title="${t.code}" value="${t.code}" class="education" lay-filter="hope">
                        </c:forEach>
                    </div>
                </div>
...
<script>
    layui.use('form', function(){
        ...
        $("#deleteStatus").val("${CustomizeGroup.deleteStatus}");
...
<script>
    layui.config({
        ...
        form.on('submit(component-form-demo)', function (data) {
            ...
            $.post("<%=request.getContextPath()%>/cg/update", data.field, function (data) {
                // 获取 session
