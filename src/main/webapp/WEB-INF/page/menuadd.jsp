    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body" style="padding: 15px;">
            <form class="layui-form" action="" lay-filter="component-form-group">
                <input type="hidden" name="auPId" id="" >
                <div class="layui-form-item">
                    <label class="layui-form-label">URL地址</label>
                    <div class="layui-input-block">
                        <input type="text" name="auUrl" lay-verify="required" autocomplete="off" placeholder="请输入URL"
                               class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="auTitle" lay-verify="required" autocomplete="off" placeholder="请输入名称"
                               class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="auInfo" lay-verify="required" autocomplete="off" placeholder="请输入描述"
                               class="layui-input">
                    </div>
                </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <select name="auType" lay-verify="required" lay-search="">
                                <option value="">直接选择或搜索选择</option>
                                <option value="1">1.平台功能</option>
                                <option value="2">2.代理商平台功能</option>
                                <option value="3">3.预留后期</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="auSort" lay-verify="required" autocomplete="off" placeholder="请输入排序数字"
                               class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="checkbox"  name="auClickable" value="0" id="auClickable" lay-skin="switch" lay-text="有效|无效">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">状态</label>
                    <div class="layui-input-block">
                        <input type="checkbox"  name="auState" id="auState" value="0" lay-skin="switch" lay-text="使用|禁用">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">功能前图标</label>
                    <div class="layui-input-block">
                        <input type="text" name="auClass" lay-verify="required" autocomplete="off" placeholder="请输入class"
                               class="layui-input">
                    </div>
                </div>
