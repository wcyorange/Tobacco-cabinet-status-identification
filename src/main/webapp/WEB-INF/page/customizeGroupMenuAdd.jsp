            ...
            <form class="layui-form" action="" lay-filter="component-form-group">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="userId" lay-verify="required" autocomplete="off" placeholder="请输入创建者ID"
                               class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="cgId" lay-verify="required" autocomplete="off" placeholder="请输入自定义分组id"
                               class="layui-input">
                    </div>
                </div>
...
<script>
    layui.config({
        ...
        form.on('submit(component-form-demo)', function (data) {
            $.post("/camera/cgMenu/add", data.field, function (data) {
                // 获取 session
                if (data.status == "succ") {
