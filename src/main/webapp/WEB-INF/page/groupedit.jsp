    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body" style="padding: 15px;">
            <form class="layui-form" action="" lay-filter="component-form-group">
                <input type="hidden" name="agId" id="agId" value="${flatformAdminGroup.agId}">
                <div class="layui-form-item">
                    <label class="layui-form-label">角色名称</label>
                    <div class="layui-input-block">
                        <input class="layui-input" type="text" name="agName" placeholder="请输入角色名称" value="${flatformAdminGroup.agName}"/>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">角色描述</label>
                    <div class="layui-input-block">
                        <input type="text" name="title" lay-verify="agInfo" autocomplete="off" placeholder="请输入角色描述" value="${flatformAdminGroup.agInfo}" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
