                ...
                <div class="layui-inline">
                    <div class="layui-input-inline">
                        <select name="status" lay-search>
                            <option value="">请选择合伙人状态</option>
                            <option value="0">待审核</option>
                            <option value="1">审核通过</option>
                            <option value="-1">审核驳回</option>
                            <option value="2">信息待完善</option>
                            <option value="3">签订成功</option>
                        </select>
                    </div>
                </div>
                <div class="layui-inline">
            ...
            <div class="layui-card-body">
                ...
                <script type="text/html" id="test-table-toolbar-toolbarDemo">
                    <div class="layui-btn-container">
                        <button class="layui-btn layui-btn-sm" lay-event="add">添加合伙人</button>
                    </div>
                </script>
...
<script>
    layui.config({
        ...
        table.render({
            ...
            ,url: 'partner/listjson' //修改这个地址，列表查询路径，数据类型见json/table/demo.js
            ...
            ,cols: [[
                ...
                ,{fixed: 'right', title:'操作', align:'center',  toolbar: '#test-table-toolbar-barDemo', width:260}
            ]]
            ,even: true
        ...
        table.on('tool(test-table-toolbar)', function(obj){
            ...
            if(obj.event === 'del'){
                ...
                parent.layui.index.openTabsPage("partner/findone?parId="+menu.parId, "查看信息");
            }
        });
    });
</script>
