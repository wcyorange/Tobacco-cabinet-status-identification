        ...
        <div class="layui-card-body" style="padding: 15px;">
            <form class="layui-form" action="" lay-filter="component-form-group">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="title" lay-verify="required" autocomplete="off" placeholder="请输入消息标题"
                               class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="msg" lay-verify="required" autocomplete="off" placeholder="请输入消息详情"
                               class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="imgUrl" lay-verify="required" autocomplete="off" placeholder="请输入事故图片"
                               class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
...
<script>
    layui.config({
        ...
        form.on('submit(component-form-demo)', function (data) {
            $.post("/camera/equipmentMessage/insert", data.field, function (data) {
                // 获取 session
                if (data.status == "succ") {
