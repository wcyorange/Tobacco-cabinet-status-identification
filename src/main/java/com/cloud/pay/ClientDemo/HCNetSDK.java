...
package com.cloud.pay.ClientDemo;

import com.cloud.pay.util.HCNetSDKPath;
...
public interface HCNetSDK extends StdCallLibrary {
    ...
    HCNetSDK INSTANCE = (HCNetSDK) Native
            .loadLibrary( HCNetSDKPath.DLL_PATH+"HCNetSDK.dll", HCNetSDK.class);
    /***宏定义***/
    //常量
...
{
    PlayCtrl INSTANCE = (PlayCtrl) Native.loadLibrary(HCNetSDKPath.DLL_PATH+"PlayCtrl.dll",
            PlayCtrl.class);
