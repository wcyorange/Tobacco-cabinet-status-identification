...
def yolo_detect(pathIn='',
                pathOut=None,
                # label_path='./cfg/history/yolov3_coco.names',
                # config_path='./cfg/history/yolov3_coco.cfg',
                # weights_path='./cfg/history/yolov3_coco.weights',
                label_path='./cfg/yolov3.names',
                config_path='./cfg/yolov3.cfg',
                weights_path='./cfg/yolov3n.weights',
                # weights_path='./cfg/yolov3d.weights',
