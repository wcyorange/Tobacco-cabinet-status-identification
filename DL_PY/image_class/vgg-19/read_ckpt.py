...
def rename_var(ckpt_path, new_ckpt_path, num_classes=3):
    with tf.Graph().as_default(), tf.compat.v1.Session().as_default() as sess:
        ...
        for var_name, shape in var_list:
            ...
            new_var_name = var_name.replace('vgg_19', 'feature')
            ...
            new_var_name = new_var_name.replace("conv3/conv3_4", "conv2d_7")

            new_var_name = new_var_name.replace("conv4/conv4_1", "conv2d_8")
            new_var_name = new_var_name.replace("conv4/conv4_2", "conv2d_9")
            new_var_name = new_var_name.replace("conv4/conv4_3", "conv2d_10")
            new_var_name = new_var_name.replace("conv4/conv4_4", "conv2d_11")

            new_var_name = new_var_name.replace("conv5/conv5_1", "conv2d_12")
            new_var_name = new_var_name.replace("conv5/conv5_2", "conv2d_13")
            new_var_name = new_var_name.replace("conv5/conv5_3", "conv2d_14")
            new_var_name = new_var_name.replace("conv5/conv5_4", "conv2d_15")
...
except_list = ['global_step', 'vgg_19/mean_rgb', 'vgg_19/fc8/biases', 'vgg_19/fc8/weights']
# http://download.tensorflow.org/models/vgg_19_2016_08_28.tar.gz
ckpt_path = './vgg_19.ckpt'
