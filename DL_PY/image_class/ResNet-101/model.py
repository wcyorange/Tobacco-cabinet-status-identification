...
class BasicBlock(layers.Layer):
    ...
    def __init__(self, out_channel, strides=1, downsample=None, **kwargs):
        ...
        self.bn1 = layers.BatchNormalization(momentum=0.9, epsilon=1e-5) #归一化
        # 第二个卷积层+BN层
...
def _resnet(block, blocks_num, im_width=224, im_height=224, num_classes=1000, include_top=True):
    ...
    x = layers.BatchNormalization(momentum=0.9, epsilon=1e-5, name="conv1/BatchNorm")(x) #momentum：移动平均线的动量. epsilon：小浮点数添加到方差以避免除以零
    x = layers.ReLU()(x)
