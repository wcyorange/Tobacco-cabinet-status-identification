...
image_path = data_root + "/image_class-master/vgg16/data/"  # flower data set path
...
model = vgg("vgg16", im_height=im_height, im_width=im_width, class_num=2)
# model = vgg("vgg16", 512, 256, 2)
